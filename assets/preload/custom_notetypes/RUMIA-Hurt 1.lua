function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'RUMIA-Hurt 1' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'specialNotes/RUMIAdodge_wave1'); --Change texture
