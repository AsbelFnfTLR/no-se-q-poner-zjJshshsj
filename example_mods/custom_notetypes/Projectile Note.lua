function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Projectile Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'specialNotes/PROJECTILENOTE_assets'); --Change texture
